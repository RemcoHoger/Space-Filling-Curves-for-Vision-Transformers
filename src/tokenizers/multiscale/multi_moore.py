...
class HierarchicalMooreEmbedding(nn.Module):
    def __init__(self, img_size, in_channels, patch_size_list, embed_dim, curve_fn=moore_curve):
        super().__init__()
...
class SFCEmbedding1D(nn.Module):
    def __init__(self, img_size, pre_patch_size, group_patch_size, in_channels, embed_dim, curve_fn=moore_curve):
        super().__init__()
